...
<body>
    ...
    <section class="board-write">
        ...
        <div class="container">
            <div class="inner">
                <form action="/WebProject/menu/BWrite.taeyeon">
                    <div class="board-writes">
                    		<input type="text" value="제목" name="bTitle" class="title" required> <br/>
                    		<input type="text" value="작성자" name="bName" class="name" required> <br/>
	                        <textarea name="bContent" cols="30" rows="40" class="board-contents"></textarea> <br/>
