        ...
        <div class="container">
            <div class="inner">
                <form action="">
                    <table class="board-list">
                        ...
                        <c:forEach var="user" items="${articles.messageList}">
	                        <tr>
	                            <td>${user.board_id}</td>
	                            <td>${user.board_writer}</td>
								<td><a href="/WebProject/menu/BContent.taeyeon?bId=${user.board_id}">${user.board_title}</a></td>
                ...
                <div class="page-write">
                    <div class="write">
                        <a href="/WebProject/menu/BWriteView.taeyeon">
  		...
  		<ul class="page-elements">
  			<c:forEach var="pageNum" begin="1" end="${articles.pageTotalCount}">
  				<li class="page">
  					...
  					href="/WebProject/menu/Blist.taeyeon?page=${pageNum}">${pageNum}</a>
  				</li>
  			</c:forEach>
  		</ul>
